...
function Footer() {
  ...
  const quickLinks = [
    ...
    { href: "/chef", text: "Become a Chef" },
    { href: "/upgrade", text: "Upgrade Plan" },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Connect with professional chefs for private cooking, catering, and culinary experiences. 
              Your personal chef is just a click away.
            </p>
